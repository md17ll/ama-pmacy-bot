...
- رفع جدول المناوبات الرسمي بصيغة Word أو إدخال المناوبة يدوياً.
- استيراد بيانات الصيدليات وتصدير النسخ بصيغة Excel.
- فحص التواريخ والأوقات والتكرار والتداخل.
- سجل عمليات، تراجع، نسخ احتياطية وإحصائيات للأزرار والأعضاء النشطين.
...
5. أنشئ Railway Cron service من المستودع نفسه بالأمر:
   ...
   و`TIMEZONE`. اضبط `RUN_MODE=polling` لخدمة Cron فقط؛ فهي لا تحتاج متغيرات
   webhook. المهمة تفحص تنبيه انتهاء الجدول مرة واحدة ثم تنتهي، بدلاً من إبقاء
   خدمة البوت مستيقظة طوال الساعة.
