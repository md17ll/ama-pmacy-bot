        ...
        texts.admin_section_text(
            ...
            stats=[
                ...
                *smart_ui._help(
                    ...
                    "✏️ تعديل الصيدليات — يغير صيدلية النهاري أو المسائي ويثبت اختيارك.",
...
async def _render_day(
    ...
    await smart_ui.safe_edit(
        ...
        texts.admin_section_text(
            ...
            "أي صيدلية تختارها تُحفظ مباشرة، وملف Word يأخذ نفس الاسم ونفس خانة النهاري/المسائي.",
            stats=[
                ...
                *smart_ui._help(
                    "☀️/🌙 تعديل — يختار صيدلية بديلة ويحفظها فوراً.",
